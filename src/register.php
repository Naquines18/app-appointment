            ...
            if($stmt->execute() == TRUE){
                ...
                //Instantiation and passing `true` enables exceptions
                    ...
                    try {
                        ...
                        Please click the verification link <a href="https://app-appointment-system.herokuapp.com/login?code='.htmlspecialchars($code).'&&charset='.$charset.'&&activation='.$activation.'&&firstname='.htmlspecialchars($firstname).'&&lastname='.htmlspecialchars($lastname).'">Verify</a>
                        ';
